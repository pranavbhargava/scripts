...
sudo scutil --set ComputerName "pranav-macbook"
sudo scutil --set HostName "pranav-macbook"
sudo scutil --set LocalHostName "pranav-macbook"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "pranav-macbook"
